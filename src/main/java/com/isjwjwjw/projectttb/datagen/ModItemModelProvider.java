...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, ProjectTTB.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        basicItem(ModItems.UPGRADE_PICKAXE.get());
        basicItem(ModItems.UPGRADE_AXE.get());
        basicItem(ModItems.UPGRADE_SHOVEL.get());
        basicItem(ModItems.UPGRADE_HOE.get());
        ...
        basicItem(ModArmorItems.TINIUM_HELMET.get());
        basicItem(ModArmorItems.TINIUM_CHESTPLATE.get());
        basicItem(ModArmorItems.TINIUM_LEGGINGS.get());
        basicItem(ModArmorItems.TINIUM_BOOTS.get());
    ...
    private void handheldItem(DeferredItem<Item> Item){
        withExistingParent(Item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(ProjectTTB.MOD_ID,
