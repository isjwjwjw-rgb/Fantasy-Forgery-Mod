...
import com.isjwjwjw.projectttb.block.infuser.InfuserBlock;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(ProjectTTB.MOD_ID);
    ...
    public static final DeferredBlock<InfuserBlock> INFUSER = registerBlock("infuser",
