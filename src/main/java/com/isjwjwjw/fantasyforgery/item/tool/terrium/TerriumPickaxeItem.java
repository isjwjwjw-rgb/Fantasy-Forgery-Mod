package com.isjwjwjw.fantasyforgery.item.tool.terrium;
...
public class TerriumPickaxeItem extends PickaxeItem {
    public TerriumPickaxeItem(Tier p_42961_, Properties p_42964_) {
